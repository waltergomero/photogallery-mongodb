...
export default function AddEditPage(props) {
  ...
  function createCategory(data) {
    data = {...data, status_name: statusName};
                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <input
                      ...
                      className={`w-full text-sm px-4 py-1 mt-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600
                                        ${
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <select
                      name="status_id"
                      {...register("status_id")}
                      className="w-full px-4 py-1 text-sm mt-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
